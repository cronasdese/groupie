...
<html>
	...
	<body>
		<div class="row">
					<button type="button" class="btn btn-link btn-block"><img src="<?php echo base_url('assets/images/logo.jpg'); ?>" class="center-block" class="rounded" data-toggle="tooltip" title="Groupie! Click to register."/></button>
		</div>
		<div class="row">
